...
import loginBg from '../../images/background_image.png';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-start p-4 lg:p-12" style={{ backgroundImage: `url(${loginBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
