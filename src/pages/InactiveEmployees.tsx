              ...
              <div className="bg-white rounded-2xl p-6">
                <form className="space-y-6" onSubmit={handleAddInactive}>
                  <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Field label="Department" error={addErrors.department}>
                      <Select
                        ...
                        onValueChange={(value) =>
                          setAddForm((prev) => ({ ...prev, department: value }))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <Field label="Retire?">
                      <Select
                        ...
                        onValueChange={(value) =>
                          setAddForm((prev) => ({ ...prev, retire: value }))
                        }
                      >
                        <SelectTrigger>
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3">
                    ...
                    <Button
                      type="submit"
                      className="rounded-full px-6 bg-[#0b5ed7] hover:bg-[#0a4fb3]"
                      disabled={isSubmitting}
                    >
